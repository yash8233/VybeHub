  ...
  return (
    <div className='w-[90%]   flex flex-col gap-[10px] bg-white items-center shadow-2xl shadow-[#00000058] rounded-2xl pb-[20px]'>
      <div className='w-full h-[80px] flex justify-between items-center px-[10px]'>
       ...
       {userData._id==post.author._id && location.pathname.includes('/profile') &&  <button onClick={handleDelete} className='px-[10px] min-w-[60px] md:min-w-[100px] py-[5px] h-[30px] md:h-[40px] bg-red-600 text-white rounded-2xl text-[14px] md:text-[16px]'>Delete</button>}
      </div>
